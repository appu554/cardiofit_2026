...
type WorkflowState struct {
	...
	// Additional UI coordination fields
...
// WorkflowUIState represents the UI-specific state of a workflow
...
// OverrideSession is now defined in override_manager.go
...
// OverrideLevel is now defined in override_manager.go
...
const (
	...
	// Override Levels are now defined in override_manager.go
