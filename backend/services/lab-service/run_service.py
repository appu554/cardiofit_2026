#!/usr/bin/env python
"""
Run script for lab-service Service.
...
# Need to go up two levels: lab-service -> services -> backend
...
# Print configuration
print("Starting lab-service Service with the following configuration:")
