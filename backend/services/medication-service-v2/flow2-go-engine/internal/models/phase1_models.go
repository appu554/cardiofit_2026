...
type MedicationRequest struct {
	...
	Preferences      Phase1PatientPreferences `json:"preferences,omitempty"`
...
type ClinicalContextInput struct {
	...
	VitalSigns       map[string]Phase1VitalSign `json:"vital_signs,omitempty"`
...
// Phase1PatientPreferences represents patient preferences and constraints in Phase 1
type Phase1PatientPreferences struct {
...
// Phase1VitalSign represents a vital sign measurement for Phase 1
type Phase1VitalSign struct {
	Value            float64                `json:"value"`
	Unit             string                 `json:"unit"`
	Timestamp        time.Time              `json:"timestamp"`
...
type DosingStrategy struct {
	...
	TitrationPlan    *Phase1TitrationPlan   `json:"titration_plan,omitempty"`
}
...
// Phase1TitrationPlan represents a titration plan for Phase 1
type Phase1TitrationPlan struct {
