#!/usr/bin/env python
"""
Run script for timeline-service Service.
...
# Need to go up two levels: timeline-service -> services -> backend
...
# Print configuration
print("Starting timeline-service Service with the following configuration:")
