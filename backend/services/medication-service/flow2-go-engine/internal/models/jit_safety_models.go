...
// PatientPreferences represents patient preferences for ranking
...
func NewJitSafetyContext(
	...
	return &JitSafetyContext{
		...
		Proposal: ProposedDose{
			...
			DoseMg:    candidate.InitialDose.Amount,
			Route:     candidate.InitialDose.Route,
			IntervalH: uint32(candidate.InitialDose.FrequencyHours),
		},
