#!/usr/bin/env python
"""
Run script for medication-service Service.
...
# Need to go up two levels: medication-service -> services -> backend
...
# Print configuration
print("Starting medication-service Service with the following configuration:")
