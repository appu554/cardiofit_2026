...
public class PatientEvent implements CanonicalEvent {
    ...
    // CanonicalEvent interface method - return timestamp as long
    @Override
    public long getTimestamp() {
        return timestamp != null ?
            timestamp.atZone(java.time.ZoneId.systemDefault()).toInstant().toEpochMilli() : 0L;
    }
    ...
    /**
     * Get payload as a combination of clinical data and metadata
     */
    public Map<String, Object> getPayload() {
        Map<String, Object> payload = new HashMap<>();
        if (clinicalData != null) {
            payload.putAll(clinicalData);
        }
        if (metadata != null) {
    ...
    public String getMedication() {
        if (clinicalData != null) {
            Object medication = clinicalData.get("medication");
            return medication != null ? medication.toString() : null;
        }
        return null;
    }
    ...
    public String getLabType() {
        if (clinicalData != null) {
            Object labType = clinicalData.get("lab_type");
            return labType != null ? labType.toString() : null;
        }
        return null;
    }
    ...
    public String getDiagnosis() {
        if (clinicalData != null) {
            Object diagnosis = clinicalData.get("diagnosis");
            return diagnosis != null ? diagnosis.toString() : null;
        }
        return null;
    }
