...
Converts LOINC CSV files to RDF/Turtle using RDFLib
Used by all regions (LOINC is international)
...
def load_loinc_hierarchy(csv_file):
    """Load LOINC hierarchy from LoincHierarchy.csv"""
    relationships = []
