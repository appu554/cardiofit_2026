// Package stability provides a dwell/flap/override evaluation engine
// for subject-state transitions. Phase 7 P7-D copied this package
// verbatim from kb-26-metabolic-digital-twin/pkg/stability (Decision 8:
// intentional duplication until a third consumer appears). When KB-26
// and KB-23 both need to evolve the engine, promote it to
// backend/shared-infrastructure and consume from both sides. Canonical
// reference: kb-26-metabolic-digital-twin/pkg/stability/engine.go.
package stability
