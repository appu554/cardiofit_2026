...
mixin _$Milestone {
  ...
  String? get achievedDate => throw _privateConstructorUsedError;
...
class _$MilestoneImpl implements _Milestone {
  ...
  @override
  String toString() {
    return 'Milestone(id: $id, title: $title, description: $description, status: $status, achievedDate: $achievedDate)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, description, status, achievedDate);
