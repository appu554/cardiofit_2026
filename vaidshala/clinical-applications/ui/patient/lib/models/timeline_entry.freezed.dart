...
abstract class $TimelineEntryCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String time, String text, String icon, bool done});
}
...
class _$TimelineEntryImpl implements _TimelineEntry {
  ...
  @override
  String toString() {
    return 'TimelineEntry(id: $id, time: $time, text: $text, icon: $icon, done: $done)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, time, text, icon, done);
