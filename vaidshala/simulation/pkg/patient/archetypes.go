...
func RAASCreatinineTolerance() VirtualPatient {
	return VirtualPatient{
		...
		Description: "ACEi increased 7 days ago. Creatinine rose 30% (90→117, delta=27 > 26 µmol/L). Expected RAAS response — NOT AKI. B-03 suppressed to PAUSE via RAAS tolerance (PG-14).",
		Labs: types.RawPatientData{
